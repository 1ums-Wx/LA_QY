...
const buttonVariants = cva('inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',{variants:{variant:{default:'bg-ink text-white hover:bg-rose',outline:'border border-black/10 bg-white/70 hover:bg-white',soft:'bg-blush text-rose hover:bg-rose/10'},size:{default:'h-11 px-5',sm:'h-9 px-4',lg:'h-13 px-7 text-base'}} ,defaultVariants:{variant:'default',size:'default'}});
